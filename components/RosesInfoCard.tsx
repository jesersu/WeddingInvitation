...
export default function RosesInfoCard({
  ...
  return (
    <section className="relative overflow-hidden w-screen max-w-none mx-[calc(50%-50vw)] rounded-2xl sm:w-full sm:max-w-5xl sm:mx-auto sm:rounded-2xl -mt-20">
      {/* Background */}
      ...
      {/* Floating paper card */}
      <div className="absolute inset-0 flex items-center justify-center border-amber-900/10 p-4 mt-20">
