...
export default function CouplePhoto({
  ...
  return (
    <section className="relative w-full max-w-5xl mx-auto -mt-16">
      {/* Frame background */}
      <div className="relative mx-auto w-full sm:w-[90%] md:w-[80%] aspect-[4/3] rounded-2xl bg-white/80 backdrop-blur-sm shadow-xl border border-terracotta p-2 sm:p-3">
