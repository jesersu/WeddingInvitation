...
export default function ChurchLocationCard({
  ...
  return (
    <section className="relative w-full overflow-hidden w-screen max-w-none mx-[calc(50%-50vw)] sm:w-full sm:max-w-5xl sm:mx-auto -mt-10">
      {/* Background */}
      ...
      <div className="absolute inset-0 grid place-items-center p-4">
        <div className="relative w-full max-w-[720px] bg-white/95 backdrop-blur-sm rounded-[40px] shadow-2xl border border-terracotta px-6 md:px-10 py-6 md:py-8">
          <div className="flex flex-col items-center text-center text-terracotta gap-3 md:gap-4">
